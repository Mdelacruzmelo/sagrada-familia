...
class Easing {
  ...
  inOutElastic() {
    ...
    ;
    if (this.t < 1)
      return -.5 * (a * Math.pow(2, 10 * (this.t -= 1)) * Math.sin((this.t * this.d - s) * (2 * Math.PI) / p)) + this.b;
  ...
  inOutBack() {
    let s = 1.70158;
    if ((this.t /= this.d / 2) < 1)
      return this.c / 2 * (this.t * this.t * (((s *= (1.525)) + 1) * this.t - s)) + this.b;
  ...
  inOutBounce() {
    if (this.t < this.d / 2)
      return this.inBounce(this.t * 2, 0) * .5 + this.b;
